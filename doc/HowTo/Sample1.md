...
最初は治療室(G4Room)のみ実体化されています。自分で登録されている機器を実体化してみましょう。

 
```
$ ./bin/PTSdemo -i  Sample1.mac
Session: /G4M/Module/list
Session: /G4M/Module/install Scatter
Session: /vis/drawVolume
```
...
/My/runaction/dumpfile Sample1.root
#
##
#/MyDynamic/Module/RTPFile  RTPLAN.dat
#/MyDynamic/DICOM/beamid 01
