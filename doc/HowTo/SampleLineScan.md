...
$ cp ./data/Sample/G4MScanBeam/LineScanSample.dat .
$ ./bin/PTSdemo -m  SampleLineScan.mac
```

- SampleLineScan_t0.root, SampleLineScan_t1.rootを出力します。
